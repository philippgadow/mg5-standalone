...
Decay_v1 = Decay(name = 'Decay_v1',
                 particle = P.v1,
                 partial_widths = {(P.t,P.t__tilde__):'(cmath.sqrt(-4*MT**2*Mv1**2 + Mv1**4)*(-6*ct1**2*MT**2*cmath.cos(theta1)**2 + 6*ct1**2*Mv1**2*cmath.cos(theta1)**2 + 36*ct1**2*MT**2*cmath.cos(theta1)*cmath.sin(theta1) - 6*ct1**2*MT**2*cmath.sin(theta1)**2 + 6*ct1**2*Mv1**2*cmath.sin(theta1)**2))/(48.*cmath.pi*abs(Mv1)**3)'})
